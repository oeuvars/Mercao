  ...
  return (
      <section className='min-h-screen'>
         ...
         <div className='flex flex-col gap-7 h-full justify-center items-center -mt-[1vw] z-20 absolute w-full'>
            ...
            <h1 className='text-center phone:text-base tablet:text-lg text-[#9B9CA1] font-satoshi-medium w-[90%] mx-auto'>Visualize workflows, automate tasks with Drag-and-drop tools to turn workflows into streamlined tasks.</h1>
            <div className='phone:w-[80%] tablet:w-[50%] md:w-[33%] lg:w-[25%] flex relative'>
               <input className='rounded-full border border-neutral-700 w-full px-5 py-4 bg-transparent placeholder:text-neutral-500 text-neutral-100 placeholder:font-satoshi-regular font-satoshi-regular text-lg animation focus:outline-none' placeholder='something@email.com'/>
