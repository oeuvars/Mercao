  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-20 gradient-text py-4 bg-clip-text text-center text-4xl font-satoshi-bold tracking-tight text-transparent md:text-7xl"
      >
        Plans That
        <br /> Fit You Best
      </motion.h1>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[800px] flex-col items-center justify-center overflow-hidden bg-[#0f0f0f] w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-[#0f0f0f] opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
